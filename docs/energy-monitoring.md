...
Questo documento descrive le regole applicate dalla linea 0.9, inclusa la release 0.9.1. Serve a rendere verificabili i numeri mostrati in dashboard e a evitare interpretazioni diverse durante il commissioning.
