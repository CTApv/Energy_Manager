...
Questo documento descrive le regole applicate dalla release 0.5.1. Serve a rendere verificabili i numeri mostrati in dashboard e a evitare interpretazioni diverse durante il commissioning.
